...
import com.shell.yuxuan.coolweather.gson.Forecast;
import com.shell.yuxuan.coolweather.gson.Weather;
import com.shell.yuxuan.coolweather.util.HttpUtil;
import com.shell.yuxuan.coolweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid="+weatherId+"&key=7cae01ba2bfc497aa3b80eb2e0b4e349";
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String wetherInfo = weather.now.more.info;
        ...
        for (Forecast forecast:weather.forecastList){
            ...
            TextView minText=(TextView)view.findViewById(R.id.mim_text);
